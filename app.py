...
app.config['MAIL_USERNAME'] = os.environ.get('EMAIL_USER')  # Set this in environment
app.config['MAIL_PASSWORD'] = os.environ.get('EMAIL_PASSWORD')  # Set this in environment
